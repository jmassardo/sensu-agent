...
# required.
$pkg_source="https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/$pkg_version/sensu-go_${pkg_version}_windows_amd64.zip"
...
$pkg_shasum="a3098e1bc0500b6a840a66c5eb40fb4fc6b6624c179e602502b251c18dbfb740"
...
function Invoke-Install {
  ...
  Copy-Item -Recurse -Force $HAB_CACHE_SRC_PATH/$pkg_dirname/* $pkg_prefix/bin
}
